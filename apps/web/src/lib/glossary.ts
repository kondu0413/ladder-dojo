...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    ...
    term: "リセット(RST)",
    aliases: ["リセット", "RST"],
    short: "通電しているあいだ、カウンタを 0 に戻す。SET で保持した出力も OFF に戻せる。",
    body: "RST は「通電している間ずっと」効きます。対象がカウンタなら現在値と完了を 0 に、SET で保持した Y / M なら OFF に戻します。押しボタンの a 接点で動かせば、押したときに 0 に戻ります。b 接点で動かすと、押していない間ずっとリセットされ続けて数えられません。",
    circuit: ladder(4)
      .row(no("X0"), counter("C0", 3))
      .row(no("X1"), reset("C0"))
      .row(no("C0"), out("Y0"))
